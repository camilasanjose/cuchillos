...
const ItemCount = ({ stock, initial, onAdd }) => {
    ...
    return (
        ...
        <div className="text-center mt-2">
          ...
          <div className="mt-2">
            <button
              className="inline-block rounded-full border border-[#f1eeee] py-2 px-7 text-base font-medium text-body-color transition hover:border-white hover:bg-black hover:text-white "
